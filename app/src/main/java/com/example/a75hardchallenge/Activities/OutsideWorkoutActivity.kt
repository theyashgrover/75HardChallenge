...
import com.example.a75hardchallenge.databinding.ActivityOutsideWorkoutBinding
...
private lateinit var binding: ActivityOutsideWorkoutBinding
private val toolbarExerciseBinding get() = binding
private lateinit var dialogbinding: DialogCustomBackConfirmationBinding

class OutsideWorkoutActivity : AppCompatActivity(),TextToSpeech.OnInitListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityOutsideWorkoutBinding.inflate(layoutInflater)
        ...
        exerciseList= Constants.defaultOutdoorWorkout()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration*1000, 1000) {
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!!- 1){
                    ...
                    finish()
                    val intent = Intent(this@OutsideWorkoutActivity , MainActivity()::class.java)

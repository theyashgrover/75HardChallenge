...
import com.example.a75hardchallenge.databinding.ActivityPushWorkoutBinding
import com.example.a75hardchallenge.databinding.DialogCustomBackConfirmationBinding
import java.util.Locale

class PushWorkoutActivity : AppCompatActivity(), TextToSpeech.OnInitListener{
    ...
    private lateinit var binding: ActivityPushWorkoutBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=ActivityPushWorkoutBinding.inflate(layoutInflater)
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration*1000, 1000) {
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!!- 1){
                    ...
                    finish()
                    val intent = Intent(this@PushWorkoutActivity , MainActivity()::class.java)

...
import com.example.a75hardchallenge.Adapters.ExerciseStatusAdapter
import com.example.a75hardchallenge.Fragments.Rules
import com.example.a75hardchallenge.Models.Constants
import com.example.a75hardchallenge.Models.ExerciseModel
import com.example.a75hardchallenge.R
import com.example.a75hardchallenge.databinding.ActivityLegWorkoutBinding
import com.example.a75hardchallenge.databinding.DialogCustomBackConfirmationBinding
import java.util.Locale

class LegWorkoutActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var exerciseTimerDuration: Long =
        45 //to prevent hardcoding of time of the exercise timer , Now we can easily alter this later in the application
    ...
    private lateinit var binding: ActivityLegWorkoutBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLegWorkoutBinding.inflate(layoutInflater)
        ...
        exerciseList = Constants.defaultPushWorkoutList()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration * 1000, 1000) {
            ...
            override fun onFinish() {
                if (currentExercisePosition < exerciseList?.size!! - 1) {
                    ...
                    finish()
                    val intent = Intent(this@LegWorkoutActivity, MainActivity()::class.java)
                    startActivity(intent)
                    val rules_fragment = Rules()
                    rules_fragment.setWorkoutStatus(true)
                }
            }
        }.start()
    }

...
import com.example.a75hardchallenge.databinding.ActivityYogaWorkoutBinding
import com.example.a75hardchallenge.databinding.DialogCustomBackConfirmationBinding
import java.util.Locale

class YogaWorkoutActivity : AppCompatActivity(),TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList= Constants.defaultYogaWorkout()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration*1000, 1000) {
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!!- 1){
                    ...
                    finish()
                    val intent = Intent(this@YogaWorkoutActivity , MainActivity()::class.java)

...
import com.example.a75hardchallenge.databinding.ActivityPullWorkoutBinding
import com.example.a75hardchallenge.databinding.DialogCustomBackConfirmationBinding
import java.util.Locale

class PullWorkoutActivity : AppCompatActivity(),TextToSpeech.OnInitListener {
    ...
    //declaring exercise list and model
    ...
    private lateinit var binding: ActivityPullWorkoutBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=ActivityPullWorkoutBinding.inflate(layoutInflater)
        ...
        exerciseList= Constants.defaultPullWorkoutList()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration*1000, 1000) {
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!!- 1){
                    ...
                    finish()
                    val intent = Intent(this@PullWorkoutActivity , MainActivity()::class.java)
